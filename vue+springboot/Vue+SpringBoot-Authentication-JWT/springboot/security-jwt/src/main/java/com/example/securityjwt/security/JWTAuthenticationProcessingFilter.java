...
public class JWTAuthenticationProcessingFilter extends AbstractAuthenticationProcessingFilter {
    ...
    protected void successfulAuthentication(HttpServletRequest request, HttpServletResponse response, FilterChain chain, Authentication authResult) throws IOException, ServletException {
        ...
        try {
            // create access token
            String accessToken = jwtHelper.generateJwtToken(authResult.getName(), authResult);
            ...
            response.setHeader(jwtHelper.HEADER_STRING, accessToken);
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
        ...
        try {
            ...
            String token = httpServletRequest.getHeader(jwtHelper.HEADER_STRING);
            if (token != null) {
                Authentication authentication = jwtHelper.getAuthenticationFromToken(token);
